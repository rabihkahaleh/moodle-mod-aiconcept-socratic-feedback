...
$string['openai_model_desc'] = 'e.g., gpt-4.1 or a compatible Responses API model id.';
$string['enable_streaming'] = 'Enable streaming';
$string['enable_streaming_desc'] = 'Stream token-by-token responses (experimental).';
$string['capability:submit'] = 'Submit code and interact with AI feedback';
$string['capability:moderate'] = 'Moderate AI feedback and view logs';
$string['capability:viewlogs'] = 'View logs';
